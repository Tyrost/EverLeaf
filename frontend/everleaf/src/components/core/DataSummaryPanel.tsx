...
const DataSummaryPanel = () => {
    ...
    return (
        ...
        <div className="w-full h-full bg-[rgba(23,23,23, 0.8)] backdrop-blur rounded-3xl p-[2%]">
            {/* Color blobs */}
            <div className="absolute top-0 left-0 w-[60%] h-[45%] bg-linear-to-br from-green-500/10 to-orange-500/20 rounded-full blur-3xl"></div>
            <div className="absolute bottom-0 right-0 w-[50%] h-[50%] bg-linear-to-tr from-green-500/10 to-orange-500/20 rounded-full blur-3xl"></div>
